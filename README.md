...
* chmod 700 *.sh 
* to install: ./install.sh (for a custom install use installCustom.sh and follow the instructions, dont worry you can exit it at anytime, but once you select an option the install will begin)
